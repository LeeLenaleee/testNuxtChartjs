  ...
  nuxtApp.vueApp.component("RouterLink", {
    ...
    setup: (props, { slots }) => {
      ...
      return () => {
        ...
        return props.custom ? (_a = slots.default) == null ? void 0 : _a.call(slots, { href: props.to, navigate, route: route2 }) : vue_cjs_prod.h("a", { href: props.to, onClick: (e) => {
          e.preventDefault();
          return navigate();
        } }, slots);
      };
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    const ErrorComponent = vue_cjs_prod.defineAsyncComponent(() => import('./error-component.75ae25fe.mjs'));
    const nuxtApp = useNuxtApp();
...
const _sfc_main = /* @__PURE__ */ vue_cjs_prod.defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<canvas${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ id: "ff" }, _attrs))}></canvas>`);
    };
  }
});
