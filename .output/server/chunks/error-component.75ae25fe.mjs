...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = vue_cjs_prod.defineAsyncComponent(() => import('./error-404.48c65b57.mjs'));
    const _Error = vue_cjs_prod.defineAsyncComponent(() => import('./error-500.6af43722.mjs'));
...
//# sourceMappingURL=error-component.75ae25fe.mjs.map
