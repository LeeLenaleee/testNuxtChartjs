...
const _sfc_main$1 = {
  ...
  setup(__props) {
    const ErrorComponent = vue_cjs_prod.defineAsyncComponent(() => import("./_nuxt/error-component.75ae25fe.js"));
    const nuxtApp = useNuxtApp();
...
const _sfc_main = /* @__PURE__ */ vue_cjs_prod.defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<canvas${ssrRenderAttrs(vue_cjs_prod.mergeProps({ id: "ff" }, _attrs))}></canvas>`);
    };
  }
});
